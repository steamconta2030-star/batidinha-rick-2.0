...
insert into public.products (id, store_id, category_id, name, description, price, position, active) values
  ('30000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', 'Batidinha de Morango', 'Cremosa, gelada e preparada na hora. Garrafa de vidro de 300 ml.', 15, 1, true),
  ('30000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', 'Batidinha de Maracujá', 'Cremosa com o azedinho do maracujá. Garrafa de vidro de 300 ml.', 15, 2, true),
  ('30000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000002', 'Combo Dupla do Rick', 'Duas batidinhas de 300 ml com sabores à escolha.', 28, 3, true)
